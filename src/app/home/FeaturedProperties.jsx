            ...
            <div key={property.prop_id} className="mt-[4rem]">
              <div className="relative slider-container">
                ...
                <a
                  ...
                  className="absolute top-[20px] lg:top-[30px] right-0 m-4 bg-[#FFF8EA] text-[#3A3A3A] border-2 border-[#F8A227] flex items-center justify-center gap-1 px-3 py-3 sm:px-4 sm:py-4 text-[10px] sm:text-[11px] rounded-full font-medium transition-all duration-300 ease-in-out hover:bg-white hover:border-yellow-500 hover:border hover:text-black hover:scale-105 shadow uppercase tracking-wider"
                >
