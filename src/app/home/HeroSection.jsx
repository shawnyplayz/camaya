  ...
  return (
    <div className="relative w-full h-screen overflow-hidden" id="home">
      ...
      <div className="relative z-10 text-heroMainTextColor px-4 sm:px-8 md:px-16 lg:px-16 h-full flex flex-col justify-center pt-28 mx-auto container">
        <div className="text-xl heroSectionDynamic font-medium  sm:text-4xl md:text-5xl lg:text-[58px] max-w-full md:max-w-[971px] text-center md:text-left lg:leading-68">
          <h1>
